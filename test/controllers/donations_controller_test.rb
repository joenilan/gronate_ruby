...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { address: @donation.address, amount: @donation.amount, currency: @donation.currency, message: @donation.message, user_id: @donation.user_id } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { address: @donation.address, amount: @donation.amount, currency: @donation.currency, message: @donation.message, user_id: @donation.user_id } }
